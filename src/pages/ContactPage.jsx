        ...
        <div className="container mx-auto px-6">
          ...
          duration: 0.8
            ...
            <motion.div className="flex justify-center mb-8">
              <motion.img src="https://horizons-cdn.hostinger.com/3739547e-79b0-4f3a-9b18-ca49e4c85466/a6266b50d1986f3d35fcc6eeeb4cc5d6.png" alt="An illustration of a cat with a contact envelope" className="max-w-md md:max-w-lg lg:max-w-xl" animate={{
              y: ["-10px", "10px", "-10px"]
            }} transition={{
              duration: 5,
              repeat: Infinity,
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
            ...
            delay: 0.2
              ...
              delay: 0.6
                ...
                <img alt="A cat popping out of a mailbox" className="max-w-xs" src="https://horizons-cdn.hostinger.com/3739547e-79b0-4f3a-9b18-ca49e4c85466/solid-0-74QR0.png" />
              </motion.div>
            </motion.div>
