        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-8 items-center mb-24">
            ...
            delay: 0.2
              ...
              <motion.img src="/images/features-software-interface.png" alt="Feature illustration showing software interface elements" className="max-w-sm md:max-w-md lg:max-w-lg" loading="lazy" animate={{
              y: ["-10px", "10px", "-10px"]
            }} transition={{
              duration: 5,
              repeat: Infinity,
