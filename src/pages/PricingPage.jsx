        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              >
                <img alt="An illustration of hands interacting with a software interface, representing flexible plans" className="max-w-sm md:max-w-md lg:max-w-lg" loading="lazy" src="/images/pricing-flexible-plans.png" />
              </motion.div>
            </motion.div>
          </div>
